...
$votes->addColumn('project_id', 'integer', array('length' => 10, 'unsigned' => true, 'notnull' => true));
...
$metainfo->addColumn('project_id', 'integer', array('length' => 10, 'unsigned' => true, 'notnull' => true));
